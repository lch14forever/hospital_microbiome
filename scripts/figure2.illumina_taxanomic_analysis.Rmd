...
## (0.5, 1]
tmp <- filter(qubit, cat=="(0.5,1]") %>% pull(`Library ID`)
d2 <- data.frame(bray=c(dist.mat[tmp, g=='Handling control']), cat='(0.5,1]')
## (1,3]
tmp <- filter(qubit, cat=="(1,3]") %>% pull(`Library ID`) 
d3 <- data.frame(bray=c(dist.mat[tmp, g=='Handling control']), cat='(1,3]')
## (3,Inf]
tmp <- filter(qubit, cat=="(3,Inf]") %>% pull(`Library ID`)
d4 <- data.frame(bray=c(dist.mat[tmp, g=='Handling control']), cat='>3')
