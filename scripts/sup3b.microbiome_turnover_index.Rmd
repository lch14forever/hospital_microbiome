---
title: "Supplimentary Figure 3b"
output:
  html_document:
    df_print: paged
---

### Supplimentary Figure 3b
...
p.g <- Heatmap(Merge, col=colorRampPalette(brewer.pal(9,'Reds'))(10),
...
### Save plots
```{r}
pdf('../plots/sup3b_microbiome_turnover_index_genus.pdf', width=4, height=7)
draw(p.g)
dev.off()
pdf('../plots/sup3b_microbiome_turnover_index_species.pdf', width=4.8, height=5)
draw(p.s)
dev.off()
```
