...
levels(dat.merged$Cubicle_room) <- stringr::str_replace_all(levels(dat.merged$Cubicle_room), c('_'=' ', 'Room'='Ward'))
...
ggsave('../plots/sup4.pca_w_arrow.pdf', height = 10, width = 20)
```
