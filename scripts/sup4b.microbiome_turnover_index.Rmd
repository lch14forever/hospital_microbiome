...
dat <- dat.bk <-  read.table('../tables/metagenomics.metaphlan2.table.g', head=TRUE, row.names=1)
...
#read
meta <- read.table('../metadata/illumina_metadata.txt', head=TRUE, row.names=2, stringsAsFactors = F)
dat <- dat.bk <- read.table('../tables/metagenomics.metaphlan2.table.s', head=TRUE, row.names=1)
